...
# The training mode
    ...
    # variable lists
    all_var_list = tf.get_collection(tf.compat.v1.GraphKeys.GLOBAL_VARIABLES)
    tfflag = tf.compat.v1.GraphKeys.MODEL_VARIABLES #tf.compat.v1.GraphKeys.TRAINABLE_VARIABLES
    ...
    if FLAGS.vgg_scaling > 0.0: # VGG weights are not trainable
        vgg_var_list = tf.get_collection(tf.compat.v1.GraphKeys.GLOBAL_VARIABLES, scope='vgg_19')
